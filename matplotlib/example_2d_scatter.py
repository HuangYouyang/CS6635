...
def print_hi(name):
    ...
    # Particle position data is listed in proper kpc/h while the halo data is in comoving Mpc/h
    convert_to_cMpc = lambda proper: (proper + width / 2.) * h_100 * kpc_to_Mpc / cosmo_a

    # 4. Plot all the particles, adding a bit of alpha so that we see the density of points.
    ...
    pl.scatter(particles_x,
               particles_y, color='b', s=1.0, alpha=0.05)

    # 5. Plot all the halos in red.
